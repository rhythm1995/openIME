...
> **本文是 2026-08-15 的翻译模型选型调研，已被 [local-model-suite.md](./local-model-suite.md) 吸收。**
> 当前翻译模型目录（MiLMMT-1B 默认 / HY-MT 1.8B 自选 / 润色兼译）与路由策略以 suite plan 为准。
